...
import { checkFuncionalidades, getCurrentUser } from '../../helpers/Utils';
  ...
  filteredList = (menuItems) => {
    ...
    if (currentUser) {
      return menuItems.filter(
        (x) =>
          (x.funcionalidades && checkFuncionalidades(x.funcionalidades)) ||
          !x.funcionalidades
      );
    }
    return menuItems;
  ...
  render() {
    ...
    return (
      <div className="sidebar">
        <div className="main-menu disable-text-selection">
        ...
        <div className="sub-menu disable-text-selection">
          <div className="scroll">
            <PerfectScrollbar
              options={{ suppressScrollX: true, wheelPropagation: false }}
            >
